...
public class ConfigVisitorFactory {private final ConfigGraphUpdater configGraphUpdater;
    private final GitHubInstallationRepository installationRepository;

    public ConfigVisitorFactory(ConfigGraphUpdater configGraphUpdater, GitHubInstallationRepository installationRepository) {
